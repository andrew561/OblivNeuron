# 1 "/tmp/tmp.pn9ZoVz4Dg.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/tmp/tmp.pn9ZoVz4Dg.c"
# 1 "/home/andrew/obliv-c/src/ext/oblivc/obliv_bits.h" 1
...
typedef int wchar_t;
# 5 "/home/andrew/obliv-c/src/ext/oblivc/obliv_bits.h" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/stdbool.h" 1 3 4
# 7 "/home/andrew/obliv-c/src/ext/oblivc/obliv_bits.h" 2



# 1 "/home/andrew/obliv-c/src/ext/oblivc/obliv_types_internal.h" 1
       
# 1 "/home/andrew/obliv-c/src/ext/oblivc/obliv_types.h" 1



# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/stddef.h" 1 3 4
# 5 "/home/andrew/obliv-c/src/ext/oblivc/obliv_types.h" 2
...
# 7 "/home/andrew/obliv-c/src/ext/oblivc/obliv_types.h" 2
# 1 "/usr/include/gcrypt.h" 1 3 4
# 28 "/usr/include/gcrypt.h" 3 4
...
# 33 "/usr/include/gcrypt.h" 2 3 4
# 45 "/usr/include/gcrypt.h" 3 4
...
# 47 "/usr/include/gcrypt.h" 2 3 4



typedef socklen_t gcry_socklen_t;
# 137 "/usr/include/gcrypt.h" 3 4
...
const char *gcry_mac_algo_name (int algorithm) __attribute__ ((__pure__));



int gcry_mac_map_name (const char *name) __attribute__ ((__pure__));
# 1418 "/usr/include/gcrypt.h" 3 4
enum gcry_kdf_algos
  {
    GCRY_KDF_NONE = 0,
...
# 1521 "/usr/include/gcrypt.h" 3 4
typedef int (*gcry_prime_check_func_t) (void *arg, int mode,
                                        gcry_mpi_t candidate);
# 1539 "/usr/include/gcrypt.h" 3 4
...
# 1574 "/usr/include/gcrypt.h" 3 4
void gcry_ctx_release (gcry_ctx_t ctx);


void gcry_log_debug (const char *fmt, ...) __attribute__ ((format (printf,1,2)));
...
# 8 "/home/andrew/obliv-c/src/ext/oblivc/obliv_types.h" 2
...
# 34 "/home/andrew/obliv-c/src/ext/oblivc/obliv_types.h"
...
struct ProtocolDesc {
  ...
  _Bool (*revealOblivBits)(ProtocolDesc*,widest_t*,const OblivBit*,size_t,int);
...
# 76 "/home/andrew/obliv-c/src/ext/oblivc/obliv_types.h"
typedef struct {
  void* sender;
...
typedef struct {
  void* recver;
  void (*recv)(void*,char*,const _Bool*,int n,int len);
  void (*release)(void*);
} OTrecver;
# 96 "/home/andrew/obliv-c/src/ext/oblivc/obliv_types.h"
...
static inline YaoProtocolDesc* protoYaoProtocolDesc(ProtocolDesc* s1) { if(*(char*)s1->extra==(1)) return s1->extra; else return ((void *)0); }
...
# 3 "/home/andrew/obliv-c/src/ext/oblivc/obliv_types_internal.h" 2
...
static inline _Bool hasBit (OIBitSrc* s) { return s->i<s->n; }
static inline _Bool curBit (OIBitSrc* s) { return s->oi[s->i].src & (1LL<<s->j); }
...
# 11 "/home/andrew/obliv-c/src/ext/oblivc/obliv_bits.h" 2
...
typedef struct { OblivBit bits[(8*sizeof(char))]; } __obliv_c__char;
typedef struct { OblivBit bits[(8*sizeof(int))]; } __obliv_c__int;
typedef struct { OblivBit bits[(8*sizeof(short))]; } __obliv_c__short;
typedef struct { OblivBit bits[(8*sizeof(long))]; } __obliv_c__long;
typedef struct { OblivBit bits[(8*sizeof(long long))]; } __obliv_c__lLong;

static const __obliv_c__bool __obliv_c__trueCond = {{{0,{1}}}};



void __obliv_c__assignBitKnown(OblivBit* dest, _Bool value);
void __obliv_c__copyBit(OblivBit* dest, const OblivBit* src);
_Bool __obliv_c__bitIsKnown(_Bool* val,const OblivBit* bit);
...
void __obliv_c__setBitsKnown(OblivBit* dest, const _Bool* value, size_t size);
void __obliv_c__copyBits(OblivBit* dest, const OblivBit* src, size_t size);

_Bool __obliv_c__allBitsKnown(const OblivBit* bits, _Bool* dest, size_t size);
...
void __obliv_c__setRShift (void* vdest, const void* vsrc, size_t size,
    unsigned shiftAmt,_Bool isSigned);
...
# 1 "/home/andrew/obliv-c/src/ext/oblivc/obliv.oh" 1
...
_Bool ocInDebugProto(void);
_Bool ocInNpProto(void);
void ocNpSetBroadcast1(_Bool v);
_Bool ocNpGetBroadcast1(void);

void setupOblivBool(OblivInputs* spec, obliv _Bool* dest, _Bool v);
...
obliv _Bool feedOblivBool(_Bool v,int party);
...
_Bool revealOblivBool(_Bool* dest, obliv _Bool src,int party);
_Bool revealOblivChar(char* dest, obliv char src,int party);
_Bool revealOblivInt(int* dest, obliv int src,int party);
_Bool revealOblivShort(short* dest, obliv short src,int party);
_Bool revealOblivLong(long* dest, obliv long src,int party);
_Bool revealOblivLLong(long long* dest, obliv long long src,int party);

_Bool ocBroadcastBool(_Bool v,int source);
...
void neuron(void *args) {
    ...
    int *weights = ((void *)0), *inputs = ((void *)0);
    load_data(io, &weights, &inputs, party);
    check_input_count(io);


    obliv int output = 0;
    obliv int *oweights = ((void *)0), *oinputs = ((void *)0);
...
void approx_logistic(protocolIO *io, obliv int *oweights, obliv int *oinputs) {
    ...
    obliv int ooutput = TAYLOR_COEFF[0];
    obliv int term = 0;
    int i, j;
    for (i = 1; i < 4; i++) {
        term = TAYLOR_COEFF[i];
...
void check_input_count(protocolIO *io) {
    ...
    if (num_weights != num_inputs) {
        fprintf(stderr, "[ERROR] (%s:%s:L%d: errno: %s) " "Unequal number of data points.\n\t" "Number of weights (party 1): %d\n\t" "Number of inputs (party 2): %d\n",
...
# 83 "neuron.oc"
 ...
 85
# 83 "neuron.oc"
        , ((*__errno_location ()) == 0 ? "None" : strerror((*__errno_location ()))), num_weights, num_inputs)

                                                                    ;
        ((*__errno_location ()) == 0 ? "None" : strerror((*__errno_location ())));
        exit(1);
    }
}
